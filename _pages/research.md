...
Macroeconomic consequences are often evaluated **at constant productive structure** : a steady state is perturbed by an exogenous demand shock. They are however **not independent**: the sectoral, distributive and institutional composition of a transition determines its effects on employment, distribution, the budget and the external balance simultaneously.
...
<ul class="structure-grid">
  ...
  <li><strong>Distribution</strong><span>Income and wealth</span></li>
  <li><strong>Demand</strong><span>Level and composition</span></li>
  <li><strong>Institutions</strong><span>Rules governing access to resources, labour and finance</span></li>
</ul>

Low-demand affects several of these at once !

Some sectors shrink (fast fashion, aviation, intensive livestock), others expand (public transport, care, education, retrofitting, repair). They differ in energy intensity, productivity dynamics, capital intensity and trade exposure, so **aggregate outcomes depend on which composition is realised**. Change also happens *within* sectors: goods built to last, smaller firms, more repair and only looking at aggregates fails capturing that. Finally it produces **winners and losers** across households, regions and firms: a transition that is not guided by distribution (in all its understandings) either widens inequalities or misses its environmental target.
